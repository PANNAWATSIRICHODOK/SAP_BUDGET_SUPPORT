CREATE PROCEDURE NDBS_BUDGET_CONTROL_BK11122025
(
...
begin
	...
	*/	
	...
	Declare cursor loopinv1 for
		...
		, CASE WHEN T1."DiscSum" = 0 THEN T0."LineTotal" ELSE T0."LineTotal"-ROUND((T0."LineTotal"/S."LineTotal")*T1."DiscSum",2) END AS "LineTotal"
		, CASE WHEN T11."DiscSum" = 0 THEN T3."LineTotal" ELSE T3."LineTotal"-ROUND((T3."LineTotal"/S."LineTotal")*T11."DiscSum",2) END AS "OldLineTotal"
		,T1."DocEntry",T0."LineNum",
		...
		left join 
		( select T0."DocEntry",SUM(T0."LineTotal") AS "LineTotal" from POR1 T0 group by  T0."DocEntry")P ON T0."DocEntry" = P."DocEntry"
		Where T0."LineTotal" <> 0  AND IFNULL(I1."InvntItem",'N') <> 'Y' AND T0."DocEntry" = :datakey;
